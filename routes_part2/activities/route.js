...
router.route("/").get(async(req, res) => {
    ...
    try {
        ...
        res.render("routes_part2/activities/index.ejs", data)
        return
...
router.route("/details").get(async(req, res) => {
    ...
    try {
        ...
        res.render("routes_part2/activities/details/index.ejs", data)
        return
...
router.route("/addActivity").get((req, res) => {
    ...
    res.render("routes_part2/activities/addActivity/index.ejs")
})
